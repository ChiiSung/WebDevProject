        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <div class="container">
            ...
            <ul class="navbar-nav ml-auto nav-right" data-easing="easeInOutExpo" data-speed="1250" data-offset="65">
              ...
              <li class="nav-item nav-custom-link">
                <a class="nav-link" href="product.html"><b>Product</b> <i class="icon ion-ios-arrow-forward icon-mobile"></i></a>
              </li>
              <li class="nav-item nav-custom-link">
                <a class="nav-link" href="event.html">Event <i class="icon ion-ios-arrow-forward icon-mobile"></i></a>
              </li>
              <li class="nav-item nav-custom-link">
                <a class="nav-link" href="aboutUs.html">About Us <i class="icon ion-ios-arrow-forward icon-mobile"></i></a>
              </li>
              <li class="nav-item nav-custom-link">
              ...
              <li class="nav-item nav-custom-link btn btn-demo-small">
                <a class="nav-link" href="#">Cart <i class="icon ion-ios-arrow-forward icon-mobile"></i></a>
              </li>
            </ul>
          </div>
        </div>
